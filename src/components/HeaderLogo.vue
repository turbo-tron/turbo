<template>
    <div class="h-56">
        <div class="f17 pf full-w hd-pf bb head-pd f-c-sb" :class="{'bg-page': showHeaderBg}">
            <img class="h-30" src="@/assets/img/logo_head.png" alt="">
        ...
        <van-popup
                ...
                class="cus-popup py15 border-main">
            <van-radio-group
                    v-model="currentLanguage"
                    checked-color="#00B9C2"
...
<style scoped>
    ...
    .head-pd { padding: 15px 20px 11px; }
    .h-56 { height: 56px; }
